...
export function freshSave(): SaveData {
  return {
    ...
    cosmetics: {},
    pvpCosmetics: { nara: {}, orin: {}, ivo: {}, sena: {} },
    gems: 0,
    gold: 0,
    upgrades: {},
    unlocked: ["nara"],
...
export const saveSchema = z.object({
  ...
  pvpCosmetics: z.object({
    nara: z.record(z.string(), ids(COSMETICS)).default({}),
    orin: z.record(z.string(), ids(COSMETICS)).default({}),
    ivo: z.record(z.string(), ids(COSMETICS)).default({}),
    sena: z.record(z.string(), ids(COSMETICS)).default({}),
  }).default(freshSave().pvpCosmetics),
  gems: count.default(0),
